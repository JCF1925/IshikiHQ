...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="capture" options={{ title: 'Capture', tabBarIcon: ({ color }) => <Feather name="plus-circle" size={22} color={color} /> }} />
      <Tabs.Screen name="health" options={{ title: 'Health', tabBarIcon: ({ color }) => <Feather name="heart" size={22} color={color} /> }} />

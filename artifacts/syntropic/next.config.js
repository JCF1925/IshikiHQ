...
const nextConfig = {
  ...
  // each active Replit preview host is loaded from the environment. Plus 127.0.0.1 because
  // Next's built-in default covers `localhost` but not the IP, and
  ...
  allowedDevOrigins: [
    '127.0.0.1',
    'c06d446a5.na120.preview.abacusai.app',
    'a2cc3b478.na120.preview.abacusai.app',
    ...new Set(replitPreviewOrigins),
  ],
};
